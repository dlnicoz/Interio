...
import "../css/ArProfile.css";
import ARprop from "./ARprop";
import $ from "jquery";

export default class ArProfile extends Component {
  jQueryCode = () => {
    (function ($) {
  ...
  render() {
    return (
      <>
        <div className="arpbody">
          <div className="axcontainer">
            {/* first card */}
            <div className="rcard" data-state="#about">
